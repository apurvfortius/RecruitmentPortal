...
class CreateQualificationPgsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Qualification_pgs", 'qualification_pgs', 'title', 'fa-user', [
    ...
    {
        if (Schema::hasTable('qualification_pgs')) {
            Schema::drop('qualification_pgs');
        }
    }
}
