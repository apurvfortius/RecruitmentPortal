...
class CreateQualificationUgsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Qualification_ugs", 'qualification_ugs', 'title', 'fa-bullhorn', [
    ...
    {
        if (Schema::hasTable('qualification_ugs')) {
            Schema::drop('qualification_ugs');
        }
    }
}
