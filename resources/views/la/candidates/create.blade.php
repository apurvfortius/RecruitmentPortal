...
@section("htmlheader_title", "Candidates Create : ".$candidate->$view_col)
	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				{!! Form::open(['action' => 'LA\CandidatesController@store', 'id' => 'candidate-add-form']) !!}
					{{-- @la_form($module) --}}
					...
					<div class="form-group">
						...
						<input list="city_list" class="form-control" placeholder="Enter City" data-rule-minlength="1" data-rule-maxlength="255" required="1" name="city" type="text" value="" aria-required="true">
					...
					<div class="form-group">
						...
						<input class="form-control" placeholder="Enter Native Place" data-rule-minlength="1" data-rule-maxlength="255" required="1" name="native_place" type="text" value="" aria-required="true">
					</div>
                    ...
                    <br>
					<div class="form-group">
						{!! Form::submit( 'Submit', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url(config('laraadmin.adminRoute') . '/candidates') }}">Cancel</a></button>
					</div>
				{!! Form::close() !!}
			</div>
		</div>
