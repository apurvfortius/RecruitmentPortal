...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $candidate->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Candidates", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/candidates/'.$candidate->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Candidates", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.candidates.destroy', $candidate->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/candidates') }}" data-toggle="tooltip" data-placement="right" title="Back to Candidates"><i class="fa fa-chevron-left"></i></a></li>
		<li class="active"><a role="tab" data-toggle="tab" class="active" href="#tab-general-info" data-target="#tab-info"><i class="fa fa-bars"></i> General Info</a></li>
		<li class=""><a role="tab" data-toggle="tab" href="#tab-timeline" data-target="#tab-timeline"><i class="fa fa-clock-o"></i> Timeline</a></li>
		<li class=""><a role="tab" data-toggle="tab" href="#tab-experience" data-target="#tab-experience"><i class="fa fa-clock-o"></i> Prior Experience</a></li>
	</ul>
	...
	<div class="tab-content">
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'native_place')
						@la_display($module, 'crnnt_desgnation')
						@la_display($module, 'report_to')
						@la_display($module, 'total_experience')
						@la_display($module, 'qualification_ug')
						@la_display($module, 'qualification_pg')
						@la_display($module, 'crrnt_ctc')
						@la_display($module, 'expected_ctc')
						@la_display($module, 'notice_period')
						@la_display($module, 'notice_buy_out')
						@la_display($module, 'age')
						@la_display($module, 'family_detail')
						@la_display($module, 'recruitor')
						@la_display($module, 'recruitor_note')
						@la_display($module, 'mobile_1')
						@la_display($module, 'mobile_2')
						@la_display($module, 'email_1')
						@la_display($module, 'email_2')
						@la_display($module, 'skype')
		...
		<div role="tabpanel" class="tab-pane fade in" id="tab-experience">
			<div class="tab-content">
				<div class="panel infolist">
					<div class="panel-default panel-heading">
					...
					<div class="panel-body">
						<table id="example1" class="table table-bordered">
							...
							<tr class="success">
								...
								<th>{{ $moduleCandidate->fields[$col]['label'] or ucfirst($col) }}</th>
								@endforeach
								@if($show_actions)
								<th>Actions</th>
								@endif
...
@push('scripts')
	...
	<script>
		...
		function approveCandidate(position, candidate) {
		$.ajax({
	...
	function rejectCandidate(position, candidate) {
		$.ajax({
