...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $candidate_experience->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Candidate_Experiences", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/candidate_experiences/'.$candidate_experience->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Candidate_Experiences", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.candidate_experiences.destroy', $candidate_experience->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/candidate_experiences') }}" data-toggle="tooltip" data-placement="right" title="Back to Candidate Experiences"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'working_from')
						@la_display($module, 'working_to')
						@la_display($module, 'job_profile')
					</div>
				</div>
			</div>
		</div>
