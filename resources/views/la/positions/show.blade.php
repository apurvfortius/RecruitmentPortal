...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $position->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Positions", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/positions/'.$position->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Positions", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.positions.destroy', $position->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/positions') }}" data-toggle="tooltip" data-placement="right" title="Back to Positions"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'position_code')
						@la_display($module, 'company_id')
						@la_display($module, 'title')
						@la_display($module, 'position_level')
						@la_display($module, 'industry_id')
						@la_display($module, 'department_id')
						@la_display($module, 'sub_department_id')
						@la_display($module, 'report_to')
						@la_display($module, 'team_size')
						@la_display($module, 'location')
						@la_display($module, 'budget_id')
						@la_display($module, 'qualification_ug')
						@la_display($module, 'qualification_pg')
						@la_display($module, 'no_position')
						@la_display($module, 'req_exp_id')
						@la_display($module, 'urgency_pos')
						@la_display($module, 'buy_out')
						@la_display($module, 'com_turnover')
						@la_display($module, 'emp_strength')
						@la_display($module, 'jd_available')
						@la_display($module, 'website')
						@la_display($module, 'pos_date')
