...
@section("contentheader_title", "Sub Departments")
@section("contentheader_description", "Sub Departments listing")
@section("section", "Sub Departments")
@section("sub_section", "Listing")
@section("htmlheader_title", "Sub Departments Listing")
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/sub_department_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
	...
	$("#sub_department-add-form").validate({
