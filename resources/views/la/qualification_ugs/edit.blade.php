	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				{!! Form::model($qualification_ug, ['route' => [config('laraadmin.adminRoute') . '.qualification_ugs.update', $qualification_ug->id ], 'method'=>'PUT', 'id' => 'qualification_ug-edit-form']) !!}
					@la_form($module)
					...
					<div class="form-group">
						{!! Form::submit( 'Update', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url(config('laraadmin.adminRoute') . '/qualification_ugs') }}">Cancel</a></button>
					</div>
				{!! Form::close() !!}
			</div>
		</div>
