...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			...
			@la_access("Countries", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.countries.destroy', $country->id], 'method' => 'delete', 'style'=>'display:inline']) }}
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'countryID')
						@la_display($module, 'countryName')
						@la_display($module, 'localName')
						@la_display($module, 'webCode')
						@la_display($module, 'region')
						@la_display($module, 'continent')
						@la_display($module, 'latitude')
						@la_display($module, 'longitude')
						@la_display($module, 'surfaceArea')
						@la_display($module, 'population')
					</div>
				</div>
			</div>
		</div>
