...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $email_tester->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Email_Testers", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/email_testers/'.$email_tester->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Email_Testers", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.email_testers.destroy', $email_tester->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/email_testers') }}" data-toggle="tooltip" data-placement="right" title="Back to Email Testers"><i class="fa fa-chevron-left"></i></a></li>
